      ...
      socket.on("joinTrip", async ({ tripId, userId }) => {
        ...
        try {
          const trip = await Trip.findById(tripId)
            .populate({
              path: "driver",
              select: "firstName lastName img", // Obtienes el nombre, apellido e imagen del conductor
            })
            .populate({
              path: "passengers",
              select: "firstName lastName img", // Obtienes el nombre, apellido e imagen de los pasajeros
            });
